...
If this client has no Jelou Skills MCP tools, use the installed `jelou-skills list`, `jelou-skills search QUERY`, `jelou-skills load ID` and `jelou-skills fetch ID@REVISION` commands for the same workflow. Read fetched files from the printed directory.
